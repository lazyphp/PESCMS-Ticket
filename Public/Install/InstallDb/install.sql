...
CREATE TABLE `pes_attachment` (
  ...
  `attachment_use_count` int(11) NOT NULL COMMENT '附件使用关联次数',
...
INSERT INTO `pes_cssend_template` VALUES (1,1,'新工单提醒','有新工单发起，单号为：{ticket_number} ，请及时处理! 详情: {handle_link}'),(2,3,'客户回复工单提醒','&lt;p&gt;工单单号{ticket_number}有新回复，请及时跟进处理。&lt;span style=&quot;background-color: rgb(255, 255, 255); font-size: 1.6rem;&quot;&gt;详情: {handle_link}&lt;/span&gt;&lt;/p&gt;'),(3,4,'工单转交通知','{old_user_name}将工单号为{ticket_number}指派给了您，请您协助他/她尽快解决该工单问题。详情: {handle_link}'),(4,504,'工单超时提醒','工单号为：{ticket_number}已在{time_out}分钟内无人受理，请您收到本消息后，尽快处理客户提交的问题。详情: {handle_link}');
...
CREATE TABLE `pes_field` (
  ...
  `field_explain` varchar(1000) NOT NULL,
...
CREATE TABLE `pes_fqa` (
  ...
  `fqa_type` int(11) NOT NULL COMMENT 'FQA文章类型',
  `fqa_link` varchar(255) NOT NULL COMMENT 'FQA外链地址',
  `fqa_is_doc` int(11) NOT NULL COMMENT '判断是否doc文档',
  PRIMARY KEY (`fqa_id`),
...
CREATE TABLE `pes_menu` (
  ...
  `menu_listsort` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `pes_menu` VALUES (1,'工单设置',0,'am-icon-ticket','',3,0),(2,'工单模型',1,'am-icon-modx','Ticket-Ticket_model-index',2,0),(3,'账号管理',0,'am-icon-users','',5,0),(4,'客服账号',3,'am-icon-user','Ticket-User-index',1,0),(6,'基础设置',9,'am-icon-tv','Ticket-Setting-action',1,0),(7,'菜单设置',9,'am-icon-map-signs','Ticket-Menu-index',20,0),(9,'系统设置',0,'am-icon-cog','',10,0),(10,'帮助文档',9,'am-icon-leanpub','https://document.pescms.com/article/3.html',998,1),(12,'工作台',0,'am-icon-tachometer','Ticket-Index-index',1,0),(13,'工单列表',0,'am-icon-yelp','',2,0),(14,'客服分组',3,'am-icon-steam','Ticket-User_group-index',2,0),(15,'节点管理',3,'am-icon-toggle-off','Ticket-Node-index',3,0),(16,'路由规则',9,'am-icon-map-o','Ticket-Route-index',50,0),(17,'工单列表',13,'am-icon-fire','Ticket-Ticket-index',2,0),(18,'我的工单',13,'am-icon-coffee','Ticket-Ticket-myTicket',3,0),(19,'通知模板',9,'am-icon-paint-brush','Ticket-Mail_template-index',80,0),(21,'工单分类',1,'am-icon-list-alt','Ticket-Category-index',1,0),(23,'客户管理',3,'am-icon-street-view','Ticket-Member-index',4,0),(24,'应用商店',9,'am-icon-cogs','Ticket-Application-shop',40,0),(25,'商业授权',9,'am-icon-registered','https://www.pescms.com/Page/Authorization.html',999,1),(26,'发送列表',9,'am-icon-send','Ticket-Send-index',60,0),(27,'全部工单',13,'am-icon-list','Ticket-Ticket-all',1,0),(32,'常见问题解答',1,'am-icon-question-circle','Ticket-Fqa-index',20,0),(33,'工单投诉反馈',0,'am-icon-cutlery','Ticket-Ticket-complain',6,0),(34,'附件管理',9,'am-icon-suitcase','Ticket-Attachment-index',90,0),(35,'客服消息模板',9,'am-icon-phone-square','Ticket-Cssend_template-index',70,0),(36,'客户分组',3,'am-icon-user-secret','Ticket-Member_organize-index',5,0),(37,'模板管理',9,'am-icon-magic','Ticket-Theme-index',110,0),(38,'公告栏',9,'am-icon-building','Ticket-Bulletin-index',120,0),(39,'前台菜单',9,'am-icon-map-signs','Ticket-Form_menu-index',130,0),(40,'日志快查',9,'am-icon-ambulance','Ticket-Log-index',970,0),(41,'本地应用',9,'am-icon-sliders','Ticket-Application-local',30,0),(42,'模板商店',9,'am-icon-shopping-bag','Ticket-Theme-shop',100,0);
...
--
-- Table structure for table `pes_send_limit`
--

DROP TABLE IF EXISTS `pes_send_limit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pes_send_limit` (
...
--
-- Dumping data for table `pes_send_limit`
--

LOCK TABLES `pes_send_limit` WRITE;
/*!40000 ALTER TABLE `pes_send_limit` DISABLE KEYS */;
/*!40000 ALTER TABLE `pes_send_limit` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pes_sms_code`
--

DROP TABLE IF EXISTS `pes_sms_code`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pes_sms_code` (
...
--
-- Dumping data for table `pes_sms_code`
--

LOCK TABLES `pes_sms_code` WRITE;
/*!40000 ALTER TABLE `pes_sms_code` DISABLE KEYS */;
/*!40000 ALTER TABLE `pes_sms_code` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `pes_ticket_chat_tips`
--

DROP TABLE IF EXISTS `pes_ticket_chat_tips`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pes_ticket_chat_tips` (
...
--
-- Dumping data for table `pes_ticket_chat_tips`
--

LOCK TABLES `pes_ticket_chat_tips` WRITE;
/*!40000 ALTER TABLE `pes_ticket_chat_tips` DISABLE KEYS */;
/*!40000 ALTER TABLE `pes_ticket_chat_tips` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `pes_ticket_model` (
  ...
  `ticket_model_img` varchar(255) NOT NULL,
...
-- Dump completed on 2025-04-03  4:56:02
