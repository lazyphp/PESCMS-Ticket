...
<a class="am-text-warning ajax-click" href="<?= $label->url(GROUP . '-' . MODULE . '-refresh', array('id' => $label->xss($value["{$fieldPrefix}id"]), 'method' => 'PUT', 'back_url' => base64_encode($_SERVER['REQUEST_URI']))) ?>" target="_blank" ><span class="am-icon-refresh"></span> 重新发送</a>
