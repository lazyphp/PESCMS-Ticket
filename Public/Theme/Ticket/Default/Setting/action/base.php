        ...
        <div class="am-g am-g-collapse">
            <div class="am-u-sm-12 am-u-sm-centered">
                <div class="am-form-group">
                    ...
                    <div class="am-alert am-alert-secondary am-text-xs " data-am-alert>
                        <i class="am-icon-lightbulb-o"></i> 授权购买请访问:《<a href="https://www.pescms.com/Page/Authorization.html" target="_blank" style="color:#0e90d2 ">商业授权</a>》
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="am-g am-g-collapse">
            <div class="am-u-sm-12 am-u-sm-centered">
                <div class="am-form-group" disabled="disabled"  >
                    ...
                    <input name="siteTitle" placeholder="网站名称" type="text" value="<?= $siteTitle['value']; ?>" <?= $license == 1 ? '' : 'readonly="readonly" data-am-popover="{content: \'需求购买使用授权方解除限制\', trigger: \'hover\', theme:\'sm\'}"' ?>>
                </div>
            </div>
        </div>
        ...
        <div class="am-g am-g-collapse">
            <div class="am-u-sm-12 am-u-sm-centered">
                <div class="am-form-group">
                    ...
                    <textarea rows="5" name="siteContact" <?= $license == 1 ? '' : 'readonly="readonly" data-am-popover="{content: \'需求购买使用授权方解除限制\', trigger: \'hover\', theme:\'sm\'}"' ?>><?= $siteContact['value']; ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div class="am-g am-g-collapse">
            <div class="am-u-sm-12 am-u-sm-centered">
                <div class="am-form-group">
                    ...
                    <textarea rows="10" name="pescmsIntroduce" <?= $license == 1 ? '' : 'readonly="readonly" data-am-popover="{content: \'需求购买使用授权方解除限制\', trigger: \'hover\', theme:\'sm\'}"' ?>><?= $pescmsIntroduce['value']; ?></textarea>
                    <div class="am-alert am-alert-secondary am-text-xs " data-am-alert>
