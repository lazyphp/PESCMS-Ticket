<div class="am-padding-xs am-padding-top-0 ticket-service">
    ...
    <?php if ($ticket_status < 3 && $ticket_close == '0' && ($user_id == $this->session()->get('ticket')['user_id'] || empty($user_id) || $label->checkAuth('TicketPUTTicketintervene') === true )): ?>
        <div class="ticket-reply">
            <form action="<?= $label->url('Ticket-Ticket-reply'); ?>" <?= $ticket_status == 0 ? '' : 'id="submit-reply"' ?> class="am-form ajax-submit" method="POST" data-am-validator>
                        ...
                        <li>
                            <div class="am-g am-g-collapse">
                                <div class="am-u-lg-12">
                                    ...
                                    <button type="submit" id="btn-submit" class="am-btn am-btn-primary am-btn-sm" data-am-loading="{spinner: 'circle-o-notch', loadingText: '提交中...', resetText: '再次提交'}">
                                        <i class="am-icon-send"></i> 提交
                                    </button>
