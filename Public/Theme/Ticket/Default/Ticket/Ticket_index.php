        ...
        <div class="am-panel-bd">
            ...
            <div class="am-g am-margin-bottom-xs am-g-collapse am-margin-top-xs">
                <div class="am-u-sm-12 am-u-md-12">
                    ...
                    <?php endforeach; ?>
                    <a href="javascript:;" class="am-btn am-btn-primary show-search-form am-btn-xs am-fl" data="<?= !empty($_GET['search']) ? '0' : '1' ?>"><i class="am-icon-search"></i>
                        工单搜索</a>
    ...
    $(function () {
        ...
        var checkSearchStatus = function () {
            ...
            if (data == '1') {
                ...
                dom.attr('data', '0')
                $('.ticket-search-form').fadeOut('50')
            } else {
                dom.html('<i class="am-icon-compress"></i> 收起搜索');
                dom.attr('data', '1')
                $('.ticket-search-form').fadeIn('50');
            }
        }
        ...
        <?php if($this->session()->get('ticket')['user_open_search'] == 1): ?>
        $('.show-search-form').trigger('click')
        <?php endif; ?>
