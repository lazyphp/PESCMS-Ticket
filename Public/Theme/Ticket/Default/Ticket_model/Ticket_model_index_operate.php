...
<a class="am-text-primary" href="<?= $label->url('Ticket-'.'Ticket_form-index', array('number' => $value["ticket_model_number"], 'cid' => $value['ticket_model_cid'],'back_url' => base64_encode($_SERVER['REQUEST_URI']))); ?>"><span class="am-icon-pencil-square-o"></span> 表单管理</a>
<i class="am-margin-left-xs am-margin-right-xs">|</i>
